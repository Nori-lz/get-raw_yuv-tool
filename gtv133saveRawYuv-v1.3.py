...
def get_raw_yuv(hostname,savepath):
    ...
    for i,raw_file in enumerate(raw_files):
        ...
        if raw_file:
            rawsavepath = f'{savepath}/{raw_file}_exp{SYSTEM_INTEGRATION_TIME}_gain{SYSTEM_SENSOR_ANALOG_GAIN}_r{SYSTEM_AWB_RED_GAIN}_b{SYSTEM_AWB_BLUE_GAIN}{spectrum}{sequence}.raw'
            try:
    ...
    for i,yuv_file in enumerate(yuv_files):
        ...
        if yuv_file:
            yuvsavepath = f'{savepath}/{yuv_file}_exp{SYSTEM_INTEGRATION_TIME}_gain{SYSTEM_SENSOR_ANALOG_GAIN}_r{SYSTEM_AWB_RED_GAIN}_b{SYSTEM_AWB_BLUE_GAIN}{spectrum}{sequence}.yuv'
            try:
                ...
                bgrsavepath = f'{savepath}/{yuv_file}_exp{SYSTEM_INTEGRATION_TIME}_gain{SYSTEM_SENSOR_ANALOG_GAIN}_r{SYSTEM_AWB_RED_GAIN}_b{SYSTEM_AWB_BLUE_GAIN}{spectrum}{sequence}.png'
