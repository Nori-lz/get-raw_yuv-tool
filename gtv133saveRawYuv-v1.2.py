...
def get_raw_yuv(hostname,savepath):
    ...
    if raw:
        ...
        rawsavepath = f'{savepath}/{rawnew}_exp{SYSTEM_INTEGRATION_TIME}_gain{SYSTEM_SENSOR_ANALOG_GAIN}_r{SYSTEM_AWB_RED_GAIN}_b{SYSTEM_AWB_BLUE_GAIN}{spectrum}.raw'
    ...
    if yuv:
        ...
        yuvsavepath = f'{savepath}/{yuvnew}_exp{SYSTEM_INTEGRATION_TIME}_gain{SYSTEM_SENSOR_ANALOG_GAIN}_r{SYSTEM_AWB_RED_GAIN}_b{SYSTEM_AWB_BLUE_GAIN}{spectrum}.yuv'
        ...
        bgrsavepath = f'{savepath}/{yuvnew}_exp{SYSTEM_INTEGRATION_TIME}_gain{SYSTEM_SENSOR_ANALOG_GAIN}_r{SYSTEM_AWB_RED_GAIN}_b{SYSTEM_AWB_BLUE_GAIN}{spectrum}.png'
